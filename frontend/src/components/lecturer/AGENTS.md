...
- `ClassScoreBreakdown` keeps `cls.error` from GET `/class`; collapsed cards show a truncated compile line, expanded cards show the full diagnostic before member rows

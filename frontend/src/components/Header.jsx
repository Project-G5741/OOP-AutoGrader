  ...
  return (
    <div className="flex items-center justify-between mb-8">
      ...
      <div className="flex items-center gap-2">
        <button
          onClick={onLogout}
          className="px-3 py-2 bg-white dark:bg-[#1A1A24] text-gray-900 dark:text-white rounded-lg border border-gray-200 dark:border-gray-700 flex items-center gap-2 shadow-sm transition-colors"
          type="button"
        >
